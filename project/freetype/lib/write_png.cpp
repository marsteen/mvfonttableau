...
namespace NPng16
{
    ...
    int png_write(const char* Filename, CDataRect& dr)
    {
        ...
        {
            case 8:
                write_pngGrayscale(Filename, dr.mWidth, dr.mHeight, dr.mData, 1);
                break;

            case 16:
                write_pngGrayscale(Filename, dr.mWidth, dr.mHeight, dr.mData, 2);
                break;

            case 24:
                write_png(Filename, dr.mWidth, dr.mHeight, 3, dr.mData);
                break;



            case 32:
                write_png(Filename, dr.mWidth, dr.mHeight, 4, dr.mData);
                break;
        }
#endif
        return 0;
